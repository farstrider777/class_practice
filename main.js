...
class KeepSecret{
  constructor (secret){
    ...
    this.myClosure = function(){ return secret }
  }
  squeal () { return this.myClosure() }
}
...
class Safe{
  constructor(x, y){
    this.keepDataSafe = function(){ return x }
    this.storeKey = function(){ return y }
  }

  unlock (key1){
    if(key1 === this.storeKey()){
      return this.keepDataSafe();
    }
  }
